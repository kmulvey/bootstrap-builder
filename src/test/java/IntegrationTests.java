...
public class IntegrationTests {
	...
	public void merge() {
		...
		URL src_path = IntegrationTests.class.getResource("/less/wells.orig.less");
		LessParser orig = new LessParser(f.readFile(new File(src_path.getPath())));
		URL override_path = IntegrationTests.class.getResource("/less/wells.less");
	...
	public void whiteSpace() {
		...
		FileUtil f = new FileUtil();
		URL src_path = IntegrationTests.class.getResource("/less/whitespace.orig.less");
		LessParser orig = new LessParser(f.readFile(new File(src_path.getPath())));
		URL override_path = IntegrationTests.class.getResource("/less/whitespace.less");
		LessParser over = new LessParser(f.readFile(new File(override_path.getPath())));
